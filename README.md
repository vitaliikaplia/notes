...
- Автоконвертація зображень у WebP (Imagick, якість 80, менша сторона до 2048px, макс. 10240x10240)
...
- Зображення — грід-галерея всіх картинок з нотаток з hover-прев'ю (назва, дата, сніпет тексту)
...
- Дата та час останнього редагування під заголовком нотатки (редактор та публічний перегляд)
...
- Drag-and-drop імпорт .md файлів та вставка зображень прямо в редактор
